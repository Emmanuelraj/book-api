...
app.put('/books/:id',(req,res)=>{
  ...
  setTimeout(async ()=>{
    let book = await checkBookExistOrNot(parseInt(req.params.id));
    ...
    else
    {
        ...
        books[idx].id = parseInt(bookId);
        books[idx].bookTitle = req.body.bookTitle;
        books[idx].bookDesc = req.body.bookDesc;
...
app.delete('/books/:id', async (req, res) => {
  try {
      ...
      if (book !== null) {
          ...
          return res.status(200).json({ message: 'Book deleted successfully', books });
      } else {
